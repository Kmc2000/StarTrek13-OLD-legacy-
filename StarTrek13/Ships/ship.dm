...
/turf/closed/wall/ship
	...
	icon_state = "wall"
	smooth = 1
	canSmoothWith = list(/turf/closed/wall/ship,/obj/machinery/door/airlock/trek, /obj/structure/window, /obj/structure/window/trek)
...
/obj/structure/catwalk/update_icon()
	var/connectdir = 0
	for(var/direction in list(1,2,3,4,5,6,7,8))
