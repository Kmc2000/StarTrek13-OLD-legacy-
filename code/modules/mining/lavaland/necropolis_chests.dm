...
//Star Trek 13 necropolis chest added items
/obj/item/sttrophy/necropolis
	name = "Necropolis Tendril Trophy"
	desc = "It looks valuable, try selling it! Might need a wash first."
	trophyname = "necropolis"
